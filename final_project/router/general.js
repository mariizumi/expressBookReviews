...
public_users.get('/author/:author',function (req, res) {
  return res.send(Object.values(books).filter(book => req.params.author === book.author));
});

// Get all books based on title
public_users.get('/title/:title',function (req, res) {
  return res.send(Object.values(books).filter(book => req.params.title === book.title));
});
